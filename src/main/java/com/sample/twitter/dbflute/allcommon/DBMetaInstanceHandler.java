package com.sample.twitter.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("relationship", "com.sample.twitter.dbflute.bsentity.dbmeta.RelationshipDbm");
        tmpMap.put("tweet", "com.sample.twitter.dbflute.bsentity.dbmeta.TweetDbm");
        tmpMap.put("user", "com.sample.twitter.dbflute.bsentity.dbmeta.UserDbm");
